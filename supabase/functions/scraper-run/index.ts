...
const DEFAULT_CREATORS: CreatorRef[] = [
  ...
  { platform: "threads", handle: "msolovei" },
  { platform: "threads", handle: "evgen_nif" },
  { platform: "threads", handle: "cleomorgause" },
  { platform: "threads", handle: "egeberkina" },
  ...
  { platform: "threads", handle: "lena.yesand" },
